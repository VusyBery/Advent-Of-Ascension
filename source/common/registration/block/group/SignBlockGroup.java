...
public final class SignBlockGroup {
	...
	public SignBlockGroup(String baseId, BlockRegistrarFactory registry, Consumer<BlockRegistrar<Block>> baseBlockRegistrar, WoodType woodType) {
		...
		this.hanging = registry.register(baseId + "_hanging_sign", registrar -> registrar.baseSign(this.freestanding, true).factory(properties -> new CeilingHangingSignBlock(woodType, properties)).itemFactory((block, properties) -> new HangingSignItem(block, wallHanging(), properties.stacksTo(16))));
