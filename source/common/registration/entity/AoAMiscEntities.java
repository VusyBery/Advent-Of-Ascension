...
public final class AoAMiscEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<ThornyPlantSproutEntity>> THORNY_PLANT_SPROUT = register("thorny_plant_sprout", EntityTypeRegistrar.<ThornyPlantSproutEntity>misc(ThornyPlantSproutEntity::new).sized(0.5f, 1.5f).clientTrackingRange(8).noSummon());
