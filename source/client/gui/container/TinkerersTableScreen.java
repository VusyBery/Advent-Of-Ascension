...
public class TinkerersTableScreen extends AbstractContainerScreen<TinkerersTableMenu> {
	...
	public TinkerersTableScreen(TinkerersTableMenu container, Inventory inv, Component guiTitle) {
	...
	private static class FrameSelectButton extends Button {
		...
		private final TinkerersTableScreen screen;
		private final Item frame;
		private final int selectionId;

		private FrameSelectButton(TinkerersTableScreen screen, int selectionId, int x, int y, Supplier<Item> frame) {
