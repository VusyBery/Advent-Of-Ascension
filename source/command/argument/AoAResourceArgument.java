...
public class AoAResourceArgument implements ArgumentType<AoAResource> {
	private static final List<String> EXAMPLES = List.of("aoa3:spirit");
	private static final DynamicCommandExceptionType UNKNOWN_RESOURCE_ERROR = new DynamicCommandExceptionType(input -> Component.translatable("argument.aoa3.resource.notFound"));
