...
public record BlasterStats(float damage, int ticksBetweenShots, float energyCost, int chargeUpTicks) {
    public static final Codec<BlasterStats> CODEC = RecordCodecBuilder.create(builder -> builder.group(
            ...
            Codec.FLOAT.fieldOf("energy_cost").forGetter(BlasterStats::energyCost),
    ...
    public static final StreamCodec<FriendlyByteBuf, BlasterStats> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.FLOAT, BlasterStats::energyCost,
            ByteBufCodecs.VAR_INT, BlasterStats::chargeUpTicks,
            BlasterStats::new);

    public static Item.Properties of(float damage, int ticksBetweenShots, float energyCost, int chargeUpTicks) {
        return new Item.Properties()
                .component(AoADataComponents.BLASTER_STATS.get(), new BlasterStats(damage, ticksBetweenShots, energyCost, chargeUpTicks))
