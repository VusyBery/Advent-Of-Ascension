...
public class MerkyreEntity extends AoAMeleeMob<MerkyreEntity> {
    ...
    protected void onHurt(DamageSource source, float amount) {
        if (!DamageUtil.isEnvironmentalDamage(source)) {
            ...
            effectCloud.setParticle(ColorParticleOption.create(effectCloud.getParticle() instanceof ColorParticleOption colorParticle ? colorParticle.getType() : ParticleTypes.ENTITY_EFFECT, ColourUtil.BLACK));
